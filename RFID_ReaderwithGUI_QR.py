...
#GPIO Output für Kaffeemaschine 
GPIO_PIN =27
...
def generate_secure_password():
    # Definiere die Zeichensätze für Großbuchstaben, Kleinbuchstaben, Zahlen und Sonderzeichen
    uppercase_letters = string.ascii_uppercase
    lowercase_letters = string.ascii_lowercase
    digits = string.digits
    special_characters = string.punctuation

    # Kombiniere die Zeichensätze zu einem Gesamtzeichensatz
    all_characters = uppercase_letters + lowercase_letters + digits + special_characters

    # Mindestlänge des Passworts
    min_length = 20

    # Generiere ein Passwort mit zufälligen Zeichen der Mindestlänge
...
# Setze die Größe der GUI auf 320x240
window_width = 320  
window_height = 240 
